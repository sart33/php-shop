...
<body>
<?php $tempVar = core\classes\LanguageController::getLanguage()?>
                    ...
                    <ul class="top-menu">
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="header-dropdown">
                                        <a href="/<?=$tempVar[3]?>"><?=$tempVar[1]?></a>

                                        <div class="header-menu">
                                            <ul>
                                              <?php  $url = $_SERVER['REQUEST_URI'];
                                               $urlArr = explode( '/', $url);
                                              if($urlArr[1] === $tempVar[3]):?>
                                              <?php array_shift($urlArr);
                                                  array_shift($urlArr);
                                              $cleanUrl = '/' . implode('/', $urlArr); ?>
                                                  <li><a href="/en<?=$cleanUrl?>">English</a></li>
                                                <li><a href="/ru<?=$cleanUrl?>">Русский</a></li>
                                                <li><a href="/ua<?=$cleanUrl?>">Українська</a></li>
        ...
        <div class="header-middle">
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="/<?= core\classes\LanguageController::getLang()?>" class="logo">
                ...
                <div class="header-center">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            <?php  $menu = \core\classes\MenuController::adminMenu()?>
                            <?php foreach ($menu as $key => $item): ?>

                            <li>
                                <a href="/<?=$tempVar[3] . $item?>" class="sf-with-ul"><?=$key?></a>
