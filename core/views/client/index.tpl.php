...
<main class="main">
    ...
    <div class="container"><div class="heading heading-center mb-3">
            <h2 class="title">
                <?='<br>'?>
                <a href="/client/insert">Отправить</a>
                <?='<br>'?>
                <?='<br>'?>

                <?php             $tel = '+38 095 241 68 84';
//               $y00 = preg_match('/[+]38\D[0][0-9]{2}\D[0-9]{3}\D[0-9]{2}\D[0-9]{2}/', $tel, $matches);
//               if(preg_match('/[+]38\D[0][0-9]{2}\D[0-9]{3}\D[0-9]{2}\D[0-9]{2}/', $tel, $matches) === 1) {
//                $y0 =  preg_replace('/([+]38)\D([0][0-9]{2})\D([0-9]{3})\D([0-9]{2})\D([0-9]{2})/', '$1$2$3$4$5', $tel);
//
//               $y1 = $matches;}
//               exit;
                ?>

                <?php if(!empty($vars) && $vars !== 0) {
                    if (is_numeric($vars)) {
                        echo 'Стоимость доставки: ' . $vars . ' грн';
                    } else {
                       echo $vars;
                    }
                }?>
<!--                --><?//=array_shift($vars);?>
        ...
        <div class="row">
            ...
            <form class="vg-wrap vg-element vg-ninteen-of-twenty" method="post" action="/client/cost">

            <input type="text"  placeholder="Тип груза" name="product_name" class="vg-input vg-text vg-firm-color1" value=""  required><br>
            <input type="text"  placeholder="Предположительный вес" name="product_weight" class="vg-input vg-text vg-firm-color1" value=""  required><br>
            <input type="text"  placeholder="Количество единиц" name="count" class="vg-input vg-text vg-firm-color1" value=""  required><br>
            <input type="text"  placeholder="Оценочная стоимость груза" name="cost" class="vg-input vg-text vg-firm-color1" value=""  required><br>
            <input type="text"  placeholder="Адресс доставки" name="address" class="vg-input vg-text vg-firm-color1" value=""  required><br>
            <textarea name="additional_info" placeholder="Дополнительная информация" class="vg-input vg-text vg-full vg-firm-color1"></textarea><br>
            ...
            <form class="vg-wrap vg-element vg-ninteen-of-twenty" method="post" action="/client/insert">

                <input type="text"  placeholder="Тип груза" name="product_name" class="vg-input vg-text vg-firm-color1" value=""  required><br>
                <input type="text"  placeholder="Предположительный вес" name="product_weight" class="vg-input vg-text vg-firm-color1" value=""  required><br>
                <input type="text"  placeholder="Количество единиц" name="count" class="vg-input vg-text vg-firm-color1" value=""  required><br>
                <input type="text"  placeholder="Оценочная стоимость груза" name="cost" class="vg-input vg-text vg-firm-color1" value=""  required><br>
                <input type="tel" placeholder=" 38 0XX XXX XX XX" name="tel" pattern="\38\D[0]{1}\[0-9]{2}\D[0-9]{2}\D[0-9]{3}\D[0-9]{2}\D[0-9]{2}" required><br>
                <input type="text"  placeholder="Адресс доставки" name="address" class="vg-input vg-text vg-firm-color1" value=""  required><br>
                <textarea name="additional_info" placeholder="Дополнительная информация" class="vg-input vg-text vg-full vg-firm-color1"></textarea><br>
